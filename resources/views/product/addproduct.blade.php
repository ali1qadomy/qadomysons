                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label
                                    for="exampleInputPassword1">{{ trans('product.Product Name English') }}:</label>
                                <input type="text" class="form-control" name="productnameEn" required>
                            </div>
                            <div class="form-group">
                                <label
                                    for="exampleInputPassword1">{{ trans('product.Product description English') }}:</label>
                            ...
                            <div class="form-group">
                                <label
                                    for="exampleInputPassword1">{{ trans('product.Product description Arabic') }}:</label>
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">{{ trans('product.boxFilling') }}:</label>
