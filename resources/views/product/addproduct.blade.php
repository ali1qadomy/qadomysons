            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select  class="form-control" name="ProdSubCategory" required>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="custom-file">
                          <input type="file" class="custom-file-input" id="inputGroupFile03" name="image" aria-describedby="inputGroupFileAddon03">
