    ...
    <div class="container table">
        <div class="row">
                        ...
                        <div class="card-header">
                            ...
                            <div class="col">
                                <div class="col-4">
                                    ...
                                    <input type="number" id="num" class="form-control" min="1" onclick="getivoice();">
                                </div>
                            </div>
                        </div>
                        <div class="col-8"></div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="number" class="form-control" id="slaeper"name="salesPerson">
                        </div>
                    </div>
                </div>
            <hr/>
            <div class="card-body">
                    ...
                    <table id="invoicetable" class="display nowrap table table-hover table-striped table-bordered"
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th>{{ trans('invoice.Discount') }}</th>
                                <th>{{ trans('invoice.total price') }}</th>
                                <th><input type="text" name="totalinvoice" class="form-control" id="alltotal" ></th>
                            </tr>
                        </tfoot>
                        <tbody class="tbodyy">
                        </tbody>
                ...
                <button type="submit" name="action" value="insert" class="btn btn-primary">{{ trans('invoice.save') }}</button>
                <button type="button" id="newinvoice" onclick="newinv();" class="btn btn-success">new
                    ivoice</button>
                    <button type="submit" name="action" id="updateinvoice" value="update" class="btn btn-warning">Update
                        ivoice</button>
                         <button type="submit" id="deleteinvoice" name="action" value="delete" class="btn btn-danger">Deleteivoice</button>
